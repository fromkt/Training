        ...
        foreach ($this->getFunctions($options['constants']) as $function) {
            ...
            switch ($functions[$name]) {
                ...
                case 'translate':
                    ...
                    $original = $args[0];
                    $domain = isset($args[1]) ? $args[1] : 'default';
                    break;
                ...
                case 'translate_with_context':
                    ...
                    $original = $args[0];
                    $context = $args[1];
                    $domain = isset($args[2]) ? $args[2] : 'default';
                    break;
                ...
                case 'n_translate':
                    ...
                    $original = $args[0];
                    $plural = $args[1];
                    $domain = isset($args[3]) ? $args[3] : 'default';
                    break;
            ...
            $match_domain = $translations->getDomain() ? $translations->getDomain() : 'default';

            $isDefaultDomain = ($domain === null || $domain === 'default');
            $isMatchingDomain = $domain === $match_domain;
