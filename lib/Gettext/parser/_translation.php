...
class Gm_Translation
{
     ...
     * @return string
     */
    public function generateId($context, $original)
    {
    ...
    {
        return $this->generateId($this->context, $this->original);
    }
    ...
    public function getTranslations()
    {
        return array(
            ...
            'plural'            =>  $this->plural,
            'pluralTranslation' =>  $this->pluralTranslation,
     ...
     * @return self
     */
    public function mergeWith($translation, $options = Gm_Merge::DEFAULTS)
    {
        Gm_Merge::mergeTranslation($translation, $this, $options);
        Gm_Merge::mergeReferences($translation, $this, $options);
        Gm_Merge::mergeComments($translation, $this, $options);
        Gm_Merge::mergeExtractedComments($translation, $this, $options);
        Gm_Merge::mergeFlags($translation, $this, $options);
