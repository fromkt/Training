...
//session_start();
require_once(GML_SNS_PATH.'/twitter/twitteroauth/twitteroauth.php');
require_once(GML_SNS_PATH.'/twitter/twitterconfig.php');
...
if (200 == $connection->http_code) {
    ...
    $(function() {
        ...
        opener.$("#twitter_icon").attr("src", "{$gml_sns_url}/icon/twitter.png");
