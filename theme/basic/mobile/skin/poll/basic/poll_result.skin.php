...
<div id="poll_result" class="new_win">
    ...
    <div class="new_win_con">
        ...
        <section id="poll_result_list">
            <h2><?php echo $po_subject ?> <?php e__('Result'); ?></h2>
            <ol>
        ...
        <div class="poll_result_wcmt">
        	<h3><span><?php e__('Opinion Title'); ?></span> <?php echo $po_etc ?></h3>
            <div id="poll_result_wcmt">
            	<div>
                    <label for="pc_idea" class="sound_only"><?php e__('Opinion'); ?><strong><?php e__('Required'); ?></strong></label>
                    <textarea id="pc_idea" name="pc_idea" class="frm_input full_input required" required maxlength="100" placeholder="<?php e__('Opinion'); ?>(<?php e__('Required'); ?>)"></textarea>
                </div>
            
                <?php if ($is_guest) { ?>
                <div class="poll_result_guest">
                	<label for="pc_name" class="sound_only"><?php e__('Name'); ?><strong><?php e__('Required'); ?></strong></label>
                    <input type="text" name="pc_name" id="pc_name" class="frm_input full_input required" required placeholder="<?php e__('Name'); ?>(<?php e__('Required'); ?>)">
                </div>
                <?php } ?>
