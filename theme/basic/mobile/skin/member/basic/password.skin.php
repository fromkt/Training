...
if ($w == 'd' || $w == 'x')
    $gml['title'] = ($w == 'x') ? __('Delete Comment') : __('Delete Post');
else
    $gml['title'] = $gml['title'];
...
<div id="pw_confirm" class="mbskin">
    ...
    <fieldset>
        <input type="password" name="wr_password" id="pw_wr_password" placeholder="<?php e__('Password'); ?>(<?php e__('Required'); ?>)" required class="frm_input required" maxLength="20">
