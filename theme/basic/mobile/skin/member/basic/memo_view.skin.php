...
<div id="memo_view" class="new_win">
	...
	<div class="new_win_con">
        ...
        <article id="memo_view_contents">
            <header>
                <h1><?php e__('Memo Content'); ?></h1>
            </header>
            <ul id="memo_view_ul">
                <li class="memo_view_name">
                    <span class="sound_only"><?php echo $kind_str ?><?php e__('User'); ?></span>
        ...
        <div class="win_btn memo_view_opt"> 
            ...
            <?php if ($kind == 'recv') { ?><a href="./memo_form.php?mb_hash=<?php echo get_string_encrypt($mb['mb_id']); ?>&amp;me_id=<?php echo $memo['me_id'] ?>" class="btn btn_b02"><?php e__('Reply'); ?></a><?php } ?>
        </div>
