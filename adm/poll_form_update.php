...
{
    $sql = " delete from {$gml['poll_table']} where po_id = '{$_POST['po_id']}' ";
    sql_query($sql);

    $sql = " delete from {$gml['poll_etc_table']} where po_id = '{$_POST['po_id']}' ";
    sql_query($sql);
}
...
sql_query(" update {$gml['config_table']} set cf_max_po_id = '{$row['max_po_id']}' ");
