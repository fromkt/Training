...
--
-- Table structure for table `gml_auth`
--

DROP TABLE IF EXISTS `gml_auth`;
CREATE TABLE IF NOT EXISTS `gml_auth` (
...
--
-- Table structure for table `gml_board`
--

DROP TABLE IF EXISTS `gml_board`;
CREATE TABLE IF NOT EXISTS `gml_board` (
...
--
-- Table structure for table `gml_board_file`
--

DROP TABLE IF EXISTS `gml_board_file`;
CREATE TABLE IF NOT EXISTS `gml_board_file` (
  `bo_table` varchar(20) NOT NULL default '',
...
--
-- Table structure for table `gml_board_good`
--

DROP TABLE IF EXISTS `gml_board_good`;
CREATE TABLE IF NOT EXISTS `gml_board_good` (
...
--
-- Table structure for table `gml_board_new`
--

DROP TABLE IF EXISTS `gml_board_new`;
CREATE TABLE IF NOT EXISTS `gml_board_new` (
...
--
-- Table structure for table `gml_config`
--

DROP TABLE IF EXISTS `gml_config`;
CREATE TABLE IF NOT EXISTS `gml_config` (
  ...
  -- `cf_instagram_clientid` varchar(100) NOT NULL DEFAULT '',
  -- `cf_instagram_secret` varchar(100) NOT NULL DEFAULT '',
...
--
-- Table structure for table `gml_cert_history`
--

DROP TABLE IF EXISTS `gml_cert_history`;
CREATE TABLE IF NOT EXISTS `gml_cert_history` (
...
--
-- Table structure for table `gml_group`
--

DROP TABLE IF EXISTS `gml_group`;
CREATE TABLE IF NOT EXISTS `gml_group` (
...
--
-- Table structure for table `gml_group_member`
--

DROP TABLE IF EXISTS `gml_group_member`;
CREATE TABLE IF NOT EXISTS `gml_group_member` (
...
--
-- Table structure for table `gml_login`
--

DROP TABLE IF EXISTS `gml_login`;
CREATE TABLE IF NOT EXISTS `gml_login` (
...
--
-- Table structure for table `gml_mail`
--

DROP TABLE IF EXISTS `gml_mail`;
CREATE TABLE IF NOT EXISTS `gml_mail` (
...
--
-- Table structure for table `gml_member`
--

DROP TABLE IF EXISTS `gml_member`;
CREATE TABLE IF NOT EXISTS `gml_member` (
...
--
-- Table structure for table `gml_memo`
--

DROP TABLE IF EXISTS `gml_memo`;
CREATE TABLE IF NOT EXISTS `gml_memo` (
...
--
-- Table structure for table `gml_point`
--

DROP TABLE IF EXISTS `gml_point`;
CREATE TABLE IF NOT EXISTS `gml_point` (
...
--
-- Table structure for table `gml_poll`
--

DROP TABLE IF EXISTS `gml_poll`;
CREATE TABLE IF NOT EXISTS `gml_poll` (
  `po_id` int(11) NOT NULL auto_increment,
...
--
-- Table structure for table `gml_poll_etc`
--

DROP TABLE IF EXISTS `gml_poll_etc`;
CREATE TABLE IF NOT EXISTS `gml_poll_etc` (
...
--
-- Table structure for table `gml_popular`
--

DROP TABLE IF EXISTS `gml_popular`;
CREATE TABLE IF NOT EXISTS `gml_popular` (
...
--
-- Table structure for table `gml_scrap`
--

DROP TABLE IF EXISTS `gml_scrap`;
CREATE TABLE IF NOT EXISTS `gml_scrap` (
...
--
-- Table structure for table `gml_visit`
--

DROP TABLE IF EXISTS `gml_visit`;
CREATE TABLE IF NOT EXISTS `gml_visit` (
...
--
-- Table structure for table `gml_visit_sum`
--

DROP TABLE IF EXISTS `gml_visit_sum`;
CREATE TABLE IF NOT EXISTS `gml_visit_sum` (
...
--
-- Table structure for table `gml_unique`
--

DROP TABLE IF EXISTS `gml_uniqid`;
CREATE TABLE IF NOT EXISTS `gml_uniqid` (
...
--
-- Table structure for table `gml_autosave`
--

DROP TABLE IF EXISTS `gml_autosave`;
CREATE TABLE IF NOT EXISTS `gml_autosave` (
...
--
-- Table structure for table `gml_qa_config`
--

DROP TABLE IF EXISTS `gml_qa_config`;
CREATE TABLE IF NOT EXISTS `gml_qa_config` (
...
--
-- Table structure for table `gml_qa_content`
--

DROP TABLE IF EXISTS `gml_qa_content`;
CREATE TABLE IF NOT EXISTS `gml_qa_content` (
...
--
-- Table structure for table `gml_content`
--

DROP TABLE IF EXISTS `gml_content`;
CREATE TABLE IF NOT EXISTS `gml_content` (
...
--
-- Table structure for table `gml_faq`
--

DROP TABLE IF EXISTS `gml_faq`;
CREATE TABLE IF NOT EXISTS `gml_faq` (
...
--
-- Table structure for table `gml_faq_master`
--

DROP TABLE IF EXISTS `gml_faq_master`;
CREATE TABLE IF NOT EXISTS `gml_faq_master` (
...
--
-- Table structure for table `gml_member_social_profiles`
--

DROP TABLE IF EXISTS `gml_member_social_profiles`;
CREATE TABLE IF NOT EXISTS `gml_member_social_profiles` (
...
--
-- Table structure for table `gml_new_win`
--

DROP TABLE IF EXISTS `gml_new_win`;
CREATE TABLE IF NOT EXISTS `gml_new_win` (
...
--
-- Table structure for table `gml_menu`
--

DROP TABLE IF EXISTS `gml_menu`;
CREATE TABLE IF NOT EXISTS `gml_menu` (
  `me_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `gml_notice`
--

DROP TABLE IF EXISTS `gml_notice`;
CREATE TABLE `gml_notice` (
...
--
-- Table structure for table `gml_multi_lang_data`
--

DROP TABLE IF EXISTS `gml_multi_lang_data`;
CREATE TABLE `gml_multi_lang_data` (
